...
Para evitar o efeito cumulativo dos sensores, todas as funções possuem um corte a 0.2 que define uma distância mínima para a influência dos sensores.
...
Este feito é obtido através da aplicação de uma velocidade com intensidade suficiente quanto o vehiculo encontra-se simultâneamente a uma pequena distância e orientado para a fêmea.
\end{enumerate}
