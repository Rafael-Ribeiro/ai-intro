...
class AggressorController(breve.BraitenbergControl):
	...
	def init(self):
		for i in range(10):
			light = breve.createInstances(breve.BraitenbergLight, 1).move(breve.vector((20 * breve.breveInternalFunctionFinder.sin(self, ((i * 6.280000) / 10))), 1, (20 * breve.breveInternalFunctionFinder.cos(self, ((i * 6.280000) / 10)))))
